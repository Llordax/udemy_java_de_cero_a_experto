...
public class EjemploClaseMath {
	...
	public static void main(String[] args) {
		...
		double techo = Math.ceil(3.5); //Redondeo por exceso
		System.out.println("techo = " + techo);
		
		double piso = Math.floor(3.5); //Redondea por defecto
		System.out.println("piso = " + piso);
		
		long entero = Math.round(Math.PI); //Redondea
		System.out.println("entero = " + entero);
		
		double exp = Math.exp(1); //Exponencial
		System.out.println("exp = " + exp);
		
		double log = Math.log(10); //Logaritmo
